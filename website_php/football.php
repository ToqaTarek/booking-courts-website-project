        ...
        <div id="form">
                <div id="form-body">
                    ...
                    <label> where do you want to play ?:</label><br>
                      <label>
                    <input type = "radio" name="place of play" value="handball court"> <label>handballcourt</label>
                    <input type = "radio" name="place of play" value="football court"> <label>football court</label>
                    <!-- <input type = "radio" name="place of play" value="volleyball"> <label>volleyball</label> -->
                   </label> 
                    <br><br>
                    <label> Match:</label><br>
                    <input type = "radio" name="light" value="3000"> <label>without lights</label>
                    <input type = "radio" name="light" value="5000"> <label>with lights</label>
                    <input type = "radio" name="light" value="500"> <label>handball court</label>
                    <br><br>

                    <label> For trainning:</label><br>
                    <input type = "radio" name="light" value="1500"required="required"> <label>without lights</label>
                    <input type = "radio" name="light" value="3000"required="required"> <label>with lights</label>
                    <input type = "radio" name="light" value="300"> <label>handball court</label>
