...
<html>
 ...
 <body> 
    ...
    <div class="screen">
        ...
        <div id="form">
            <form  onsubmit="return validation()" name="regForm" method="Post" action="signup_insert.php">
                <div id="form-body">
                    <div id="singupimg">
                    ...
                    <div id="password"> <input type ="password" name="password" placeholder="Enter Password">
                    </div>
                    <br><br>
