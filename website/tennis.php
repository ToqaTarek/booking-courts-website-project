...
<html  lang="en" dir="ltr">
 <head>
    <title> ground tennis court</title>
    <link rel="stylesheet" href="style/tennis.css"> 
    <meta charset="UTF-8">
 ...
 <body> 
    ...
    <div class="screen">
        ...
        <div id="booking-body">
            <div id="bookimg">
              <img src="img/retreiveOnePIC.jpg" style="width: 20%; "> </div> 
            </div>
            <div id="price">
                <label> one hour in the ground tennis court: 200 EGP</label>
        ...
        <div id="form">
                <div id="form-body">
                    ...
                    <br> <br>
                    <label>Enter number of hours :</label><br>
                     <label>
                    <input type = "number" name="number of hours" value="number"> 
