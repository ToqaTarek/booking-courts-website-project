...
<html  lang="en" dir="ltr">
 ...
 <body> 
    ...
    <div class="screen">
        ...
        <div id="booking-body">
            <div id="bookimg">
              <img src="img/gym.jpg" style="width: 20%; "> </div> 
            </div>
            <div id="price">
                <label> Team use of the gym: 800 EGP</label>
                <label> member of team use<br>(steam,sauna,bath or jacuzzi):150 EGP</label>
        ...
        <div id="form">
                <div id="form-body">
                    <div id="singupimg">
                        ...
                        <h3> Team courts </h3><br><br>
                    
                    </div> 
                    <br> <br>
                    <label> what do you want to play ?:</label><br>
                     <label>
                    <input type = "radio" name="kind of play" value="800"> <label>gym</label>
                    <input type = "radio" name="kind of play" value="150"> <label>steam</label>
                    <input type = "radio" name="kind of play" value="150"> <label>sauna</label>
                   </label>
                    <br>
                    <!-- <label> Match:</label><br> -->
                    <input type = "radio" name="kind of play" value="150"> <label>bath</label>
                    <input type = "radio" name="kind of play" value="150"> <label>jacuzzi</label>
                    <br> <!-- <br>
